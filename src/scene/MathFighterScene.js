...
export default class MathFighterScene extends Phaser.Scene
{
    ...
    preload(){
        ...
        this.load.spritesheet('enemies', 'images/warrior2.png', {frameWidth: 80, frameHeight: 80})
    ...
    create(){
        ...
        this.enemies = this.physics.add.sprite(
            this.gameHalfWidth + 150,
            this.gameHalfHeight - 200, 'enemies')
            .setBounce(0.2)
            .setOffset(-20,-10)
            .setOffset(20,-10).setBounce(0.2)
            .setFlipX(true)
    ...
    update(){
        if(this.correctAnswer === true && !this.playerAttack) {
            ...
            this.time.delayedCall(500, () => {
                this.createSlash(this.player.x+80,this.player.y,
                4, 600)
            })
        ...
        if (this.correctAnswer === undefined){
            ...
            this.enemies.anims.play('enemies-standby', true)
        }
        if(this.correctAnswer === false && !this.enemyAttack){
            this.enemies.anims.play('enemy-attack', true)
            this.time.delayedCall(500, () => {
                this.createSlash(this.enemies.x-60,
                this.enemies.y,2,-600,true)
            })
